...
public class WeChatPayUtil {
     ...
     * @return string
     */
    private String jsapi(String orderNum, BigDecimal total, String description, String openid) throws IOException {
     ...
     * @return json
     */
    public JSONObject pay(String orderNum, BigDecimal total, String description, String openid) throws SignatureException, NoSuchAlgorithmException, IOException, InvalidKeyException {
        //统一下单，生成预支付交易单
     ...
     * @return string
     */
    public String refund(String outTradeNo, String outRefundNo, BigDecimal refund, BigDecimal total) throws IOException {
        JSONObject jsonObject = new JSONObject();
